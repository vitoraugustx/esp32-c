...
void setup() {
  ...
  byte ledBrightness = 50; //brilho do led ( 0 a 255)
  byte sampleAverage = 5; //Define a média de amostras para cada leitura
...
void loop() {
  ...
  if (fingerDetected) {
    ...
    Serial.print("HRvalid:"); Serial.print(validHeartRate, DEC); Serial.print(",");
